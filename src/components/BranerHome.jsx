...
//     const handleNext=()=>{
//         if(currentImage < branerData.length -1){
...
//                         return (
//                             <div key={data.id+"branerHome"+index} className='min-w-full min-h-[450px]  md:min-h-full overflow-hidden relative group transition-all' style={{transform:`translatex(-${currentImage*100}%)`}}>
//                                 <div className='w-full h-full'>
//                                     <img src={imageURL + data.backdrop_path} alt="images" className='h-full w-full' />
//                                 </div>
//                                 {/* { add button for previous and nex div tag } */}
